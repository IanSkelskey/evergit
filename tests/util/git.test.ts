import { GitFileStatus, stageAllFiles, getCurrentBranchName, getStatusForFile, hasGitChanges, isInGitRepo } from '../../src/util/git';
...
describe('Git Utilities', () => {
	...
	describe('isInGitRepo', () => {
		...
		test('should return false if not inside a Git repository', () => {
			(execSync as jest.Mock).mockImplementationOnce(() => { throw new Error(); });
